...
Ext.define('SailPoint.RemediationDialog', {
    ...
    reset : function(){
        ...
        this.setTitle(Ext.String.htmlEncode(titleText));
        ...
        Ext.Ajax.request({
            ...
            success: function(response){
                ...
                if (assignmentCmp && assignmentOpts && assignmentOpts.length > 0){
                    var records = [];
                    Ext.each(assignmentOpts, function(item){
                ...
                if (this.decision.requiresDelegationReview){
                    ...
                    Ext.getDom('remediationDelegationReviewMsg').innerHTML = formatted;
                ...
                if (respObj.remediationAction == "SendProvisionRequest"){
                    ...
                    Ext.getDom('provisioningMessageContent').innerHTML = provMsg;
            ...
            */
            failure: function(response){
                this.hideMask();
                Ext.each(SailPoint.Decider.getInstance().gridIds, function(gridId){
